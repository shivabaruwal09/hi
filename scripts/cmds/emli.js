...
mentions: ment,
  ...
  message.reply({
    body: `Enjoy this music with EMLI-AI ❣️`,
    mentions: ment,
  ...
  message.reply({
    body: `Enjoy this video with EMLI-AI ❣️`,
    mentions: ment,
    attachment: await global.utils.getStreamFromURL(link)
  });
}
        ...
        message.reply({
          body: `Hello ${name}, I'm EMLI AI. Here is you answer : \n\n ${lado} \n\n Thanks to using me. Love from EMLI-AI owner 😽`,
          mentions: ment,
        });
      }
    } catch (error) {
