...
module.exports = {
 ...
 onStart: async function({ event, api, args , message }) {
		...
		const response = await axios.get(`https://sandip-api.onrender.com/gay?uid=${id}`, { responseType: 'stream' });
		...
		writer.on('finish', async () => {
			...
			await api.sendMessage({ body: "why are you gay👿", attachment: attachment }, threadID, messageID);
